...
uint32_t tmux_write(struct bufferevent *bev, uint8_t *data, uint32_t length, struct tmux_stream *stream);

uint32_t tmux_read(struct bufferevent *bev, struct tmux_stream *stream, uint32_t len);
